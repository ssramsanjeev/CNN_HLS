...
wire   [3:0] add_ln152_fu_157_p2;
reg   [3:0] add_ln152_reg_238;
reg   [3:0] add_ln152_reg_238_pp0_iter1_reg;
reg   [3:0] add_ln152_reg_238_pp0_iter2_reg;
...
wire   [7:0] sub_ln27_3_fu_199_p2;
reg   [7:0] sub_ln27_3_reg_296;
...
reg    out_r_we0_local;
wire   [7:0] sub_ln27_5_fu_221_p2;
reg    out_r_ce0_local;
wire   [10:0] tmp_s_fu_163_p3;
wire   [7:0] shl_ln27_fu_188_p2;
wire   [7:0] sub_ln27_fu_194_p2;
wire   [7:0] tmp_16_fu_205_p3;
wire   [7:0] sub_ln27_4_fu_217_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        zext_ln24_reg_243[10 : 7] <= zext_ln24_fu_171_p1[10 : 7];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        sub_ln27_3_reg_296 <= sub_ln27_3_fu_199_p2;
    end
end
...
assign add_ln152_fu_157_p2 = (ap_sig_allocacmp_i_23 + 4'd1);
...
assign icmp_ln151_fu_151_p2 = ((ap_sig_allocacmp_i_23 == 4'd14) ? 1'b1 : 1'b0);

assign out_r_address0 = zext_ln152_fu_212_p1;

assign out_r_ce0 = out_r_ce0_local;

assign out_r_d0 = sub_ln27_5_fu_221_p2;
...
assign sub_ln27_3_fu_199_p2 = (sub_ln27_fu_194_p2 - p_ZL4demo_1_1_q0);

assign sub_ln27_4_fu_217_p2 = (sub_ln27_3_reg_296 - p_ZL4demo_2_0_load_reg_286);

assign sub_ln27_5_fu_221_p2 = (sub_ln27_4_fu_217_p2 - p_ZL4demo_2_1_load_reg_291);

assign sub_ln27_fu_194_p2 = (shl_ln27_fu_188_p2 - add_ln27_reg_281);

assign tmp_16_fu_205_p3 = {{add_ln152_reg_238_pp0_iter2_reg}, {4'd0}};

assign tmp_s_fu_163_p3 = {{ap_sig_allocacmp_i_23}, {7'd0}};

assign zext_ln152_fu_212_p1 = tmp_16_fu_205_p3;

assign zext_ln24_fu_171_p1 = tmp_s_fu_163_p3;

always @ (posedge ap_clk) begin
    zext_ln24_reg_243[6:0] <= 7'b0000000;
    zext_ln24_reg_243[63:11] <= 53'b00000000000000000000000000000000000000000000000000000;
end
