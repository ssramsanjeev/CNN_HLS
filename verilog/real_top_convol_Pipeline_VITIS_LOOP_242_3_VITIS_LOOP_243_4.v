...
output   ap_idle;
output   ap_ready;
output  [11:0] inter_2_address0;
output   inter_2_ce0;
input  [7:0] inter_2_q0;
output  [11:0] inter_2_address1;
output   inter_2_ce1;
input  [7:0] inter_2_q1;
output  [9:0] inter_3_address0;
output   inter_3_ce0;
output   inter_3_we0;
...
wire   [5:0] select_ln242_fu_188_p3;
reg   [5:0] select_ln242_reg_345;
reg   [4:0] tmp_s_reg_350;
reg   [4:0] tmp_s_reg_350_pp0_iter1_reg;
wire   [4:0] tmp_28_fu_235_p4;
reg   [4:0] tmp_28_reg_362;
reg   [4:0] tmp_28_reg_362_pp0_iter1_reg;
...
reg   [6:0] j_fu_60;
wire   [6:0] add_ln243_fu_260_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_j_load;
reg   [6:0] i_fu_64;
wire   [6:0] select_ln242_1_fu_200_p3;
reg   [6:0] ap_sig_allocacmp_i_load;
reg   [10:0] indvar_flatten_fu_68;
wire   [10:0] add_ln242_1_fu_158_p2;
reg   [10:0] ap_sig_allocacmp_indvar_flatten_load;
reg    inter_2_ce1_local;
reg   [11:0] inter_2_address1_local;
reg    inter_2_ce0_local;
reg   [11:0] inter_2_address0_local;
reg    inter_3_we0_local;
reg    inter_3_ce0_local;
wire   [0:0] tmp_fu_180_p3;
wire   [5:0] trunc_ln242_fu_170_p1;
wire   [6:0] add_ln242_fu_174_p2;
wire   [5:0] trunc_ln244_fu_208_p1;
wire   [11:0] add_ln_fu_222_p3;
wire   [11:0] tmp_29_fu_245_p4;
wire   [6:0] zext_ln242_fu_196_p1;
wire   [11:0] add_ln244_1_fu_281_p4;
wire   [11:0] tmp_30_fu_294_p5;
wire   [9:0] tmp_31_fu_309_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        tmp_28_reg_362 <= {{select_ln242_fu_188_p3[5:1]}};
        tmp_28_reg_362_pp0_iter1_reg <= tmp_28_reg_362;
        tmp_s_reg_350 <= {{select_ln242_1_fu_200_p3[5:1]}};
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001_ignoreCallOp54) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        max_ret7_reg_403 <= max_ret7_max_fu_283_p_dout0;
    end
end
...
assign add_ln242_1_fu_158_p2 = (ap_sig_allocacmp_indvar_flatten_load + 11'd1);

assign add_ln242_fu_174_p2 = (ap_sig_allocacmp_i_load + 7'd2);

assign add_ln243_fu_260_p2 = (zext_ln242_fu_196_p1 + 7'd2);
...
assign icmp_ln242_fu_152_p2 = ((ap_sig_allocacmp_indvar_flatten_load == 11'd1024) ? 1'b1 : 1'b0);
...
assign inter_3_d0 = max_ret7_reg_403;

assign inter_3_we0 = inter_3_we0_local;

assign max_ret7_max_fu_283_p_din1 = inter_2_load_reg_378;

assign max_ret7_max_fu_283_p_din2 = inter_2_load_1_reg_388;

assign max_ret7_max_fu_283_p_din3 = inter_2_load_2_reg_393;

assign max_ret7_max_fu_283_p_din4 = inter_2_load_3_reg_398;

assign select_ln242_1_fu_200_p3 = ((tmp_fu_180_p3[0:0] == 1'b1) ? add_ln242_fu_174_p2 : ap_sig_allocacmp_i_load);

assign select_ln242_fu_188_p3 = ((tmp_fu_180_p3[0:0] == 1'b1) ? 6'd0 : trunc_ln242_fu_170_p1);

assign tmp_28_fu_235_p4 = {{select_ln242_fu_188_p3[5:1]}};

assign tmp_29_fu_245_p4 = {{{trunc_ln244_fu_208_p1}, {tmp_28_fu_235_p4}}, {1'd1}};

assign tmp_30_fu_294_p5 = {{{{tmp_s_reg_350}, {1'd1}}, {tmp_28_reg_362}}, {1'd1}};

assign tmp_31_fu_309_p3 = {{tmp_s_reg_350_pp0_iter1_reg}, {tmp_28_reg_362_pp0_iter1_reg}};

assign tmp_fu_180_p3 = ap_sig_allocacmp_j_load[32'd6];

assign trunc_ln242_fu_170_p1 = ap_sig_allocacmp_j_load[5:0];

assign trunc_ln244_fu_208_p1 = select_ln242_1_fu_200_p3[5:0];

assign zext_ln242_fu_196_p1 = select_ln242_fu_188_p3;

assign zext_ln244_1_fu_289_p1 = add_ln244_1_fu_281_p4;

assign zext_ln244_2_fu_255_p1 = tmp_29_fu_245_p4;

assign zext_ln244_3_fu_304_p1 = tmp_30_fu_294_p5;

assign zext_ln244_4_fu_315_p1 = tmp_31_fu_309_p3;
