...
input  [7:0] p_ZL4demo_1_2_load_16;
...
reg   [7:0] ap_sig_allocacmp_par1_load_14;
wire    ap_loop_init;
...
mac_muladd_8s_2ns_8ns_8_4_1_U321(
    ...
    .din0(grp_fu_211_p0),
    .din1(grp_fu_211_p1),
    .din2(ap_sig_allocacmp_par1_load_14),
    .ce(1'b1),
    .dout(grp_fu_211_p3)
);
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
        ap_sig_allocacmp_par1_load_14 = grp_fu_211_p3;
    end else begin
        ap_sig_allocacmp_par1_load_14 = par1_fu_48;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter4 == 1'b1))) begin
        ap_sig_allocacmp_par2_load_14 = grp_fu_220_p3;
    end else begin
...
assign grp_fu_211_p0 = ((icmp_ln88_reg_276[0:0] == 1'b1) ? p_ZL4demo_1_1_load_29 : p_ZL4demo_0_1_load_17);

assign grp_fu_211_p1 = grp_fu_211_p10;

assign grp_fu_211_p10 = gaussian_0_q0;

assign grp_fu_220_p0 = ((icmp_ln88_reg_276[0:0] == 1'b1) ? p_ZL4demo_1_2_load_16 : p_ZL4demo_0_2_load_10);
