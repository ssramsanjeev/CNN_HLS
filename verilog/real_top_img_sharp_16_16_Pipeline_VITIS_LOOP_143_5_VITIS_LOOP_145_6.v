...
reg   [3:0] i_load_reg_432;
reg   [3:0] i_load_reg_432_pp0_iter1_reg;
reg   [3:0] i_load_reg_432_pp0_iter2_reg;
...
wire   [3:0] indvars_iv_next3029_fu_258_p2;
reg   [3:0] indvars_iv_next3029_reg_442;
reg   [3:0] indvars_iv_next3029_reg_442_pp0_iter1_reg;
reg   [3:0] indvars_iv_next3029_reg_442_pp0_iter2_reg;
wire   [63:0] zext_ln11_fu_282_p1;
reg   [63:0] zext_ln11_reg_447;
wire   [3:0] add_ln147_fu_290_p2;
reg   [3:0] add_ln147_reg_476;
reg   [3:0] add_ln147_reg_476_pp0_iter1_reg;
reg   [3:0] add_ln147_reg_476_pp0_iter2_reg;
wire   [6:0] empty_fu_311_p1;
reg   [6:0] empty_reg_506;
wire   [6:0] empty_47_fu_315_p1;
reg   [6:0] empty_47_reg_511;
wire   [6:0] tmp1_fu_327_p2;
reg   [6:0] tmp1_reg_516;
reg   [7:0] par3_reg_521;
wire   [7:0] add_ln15_fu_356_p2;
reg   [7:0] add_ln15_reg_526;
wire   [7:0] add_ln15_12_fu_368_p2;
reg   [7:0] add_ln15_12_reg_531;
...
reg   [3:0] i_fu_70;
wire   [3:0] select_ln143_7_fu_264_p3;
reg   [3:0] ap_sig_allocacmp_i_load;
reg   [7:0] indvar_flatten42_fu_74;
wire   [7:0] add_ln143_fu_232_p2;
...
reg    out_r_we0_local;
wire   [7:0] add_ln15_13_fu_401_p2;
reg    out_r_ce0_local;
wire   [3:0] select_ln143_fu_250_p3;
wire   [9:0] tmp_s_fu_272_p4;
wire   [6:0] empty_48_fu_319_p1;
wire   [6:0] empty_49_fu_323_p1;
wire   [6:0] tmp_fu_339_p2;
wire   [6:0] tmp21_fu_343_p2;
wire   [7:0] shl_ln15_fu_333_p2;
wire   [7:0] tmp3_fu_348_p3;
wire   [7:0] add_ln15_11_fu_362_p2;
wire   [3:0] indvars_iv_next30_mid1_fu_374_p2;
wire   [3:0] select_ln143_8_fu_379_p3;
wire   [7:0] tmp_15_fu_385_p3;
wire   [7:0] add_ln15_10_fu_397_p2;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln143_fu_226_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_fu_70 <= select_ln143_7_fu_264_p3;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        empty_47_reg_511 <= empty_47_fu_315_p1;
        ...
        zext_ln11_reg_447[3 : 0] <= zext_ln11_fu_282_p1[3 : 0];
zext_ln11_reg_447[9 : 6] <= zext_ln11_fu_282_p1[9 : 6];
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b0 == ap_block_pp0_stage0_11001)) begin
        ...
        add_ln15_12_reg_531 <= add_ln15_12_fu_368_p2;
...
assign add_ln143_fu_232_p2 = (ap_sig_allocacmp_indvar_flatten42_load + 8'd1);

assign add_ln147_fu_290_p2 = (select_ln143_fu_250_p3 + 4'd1);

assign add_ln15_10_fu_397_p2 = (add_ln15_reg_526 + par3_reg_521);

assign add_ln15_11_fu_362_p2 = (shl_ln15_fu_333_p2 + tmp3_fu_348_p3);

assign add_ln15_12_fu_368_p2 = (add_ln15_11_fu_362_p2 + p_ZL4demo_2_2_q0);

assign add_ln15_13_fu_401_p2 = (add_ln15_12_reg_531 + add_ln15_10_fu_397_p2);
...
assign empty_47_fu_315_p1 = p_ZL4demo_1_0_q0[6:0];

assign empty_48_fu_319_p1 = p_ZL4demo_1_2_q0[6:0];

assign empty_49_fu_323_p1 = p_ZL4demo_2_1_q0[6:0];

assign empty_fu_311_p1 = p_ZL4demo_0_1_q0[6:0];

assign icmp_ln143_fu_226_p2 = ((ap_sig_allocacmp_indvar_flatten42_load == 8'd196) ? 1'b1 : 1'b0);

assign icmp_ln145_fu_244_p2 = ((ap_sig_allocacmp_j_load == 4'd14) ? 1'b1 : 1'b0);

assign indvars_iv_next3029_fu_258_p2 = (ap_sig_allocacmp_i_load + 4'd1);

assign indvars_iv_next30_mid1_fu_374_p2 = (i_load_reg_432_pp0_iter2_reg + 4'd2);

assign out_r_address0 = zext_ln147_fu_392_p1;

assign out_r_ce0 = out_r_ce0_local;

assign out_r_d0 = add_ln15_13_fu_401_p2;
...
assign select_ln143_7_fu_264_p3 = ((icmp_ln145_fu_244_p2[0:0] == 1'b1) ? indvars_iv_next3029_fu_258_p2 : ap_sig_allocacmp_i_load);

assign select_ln143_8_fu_379_p3 = ((icmp_ln145_reg_437_pp0_iter2_reg[0:0] == 1'b1) ? indvars_iv_next30_mid1_fu_374_p2 : indvars_iv_next3029_reg_442_pp0_iter2_reg);

assign select_ln143_fu_250_p3 = ((icmp_ln145_fu_244_p2[0:0] == 1'b1) ? 4'd0 : ap_sig_allocacmp_j_load);

assign shl_ln15_fu_333_p2 = p_ZL4demo_1_1_q0 << 8'd2;

assign tmp1_fu_327_p2 = (empty_48_fu_319_p1 + empty_49_fu_323_p1);

assign tmp21_fu_343_p2 = (tmp1_reg_516 + tmp_fu_339_p2);

assign tmp3_fu_348_p3 = {{tmp21_fu_343_p2}, {1'd0}};

assign tmp_15_fu_385_p3 = {{select_ln143_8_fu_379_p3}, {add_ln147_reg_476_pp0_iter2_reg}};

assign tmp_fu_339_p2 = (empty_47_reg_511 + empty_reg_506);

assign tmp_s_fu_272_p4 = {{{select_ln143_7_fu_264_p3}, {2'd0}}, {select_ln143_fu_250_p3}};

assign zext_ln11_fu_282_p1 = tmp_s_fu_272_p4;

assign zext_ln147_fu_392_p1 = tmp_15_fu_385_p3;

always @ (posedge ap_clk) begin
    zext_ln11_reg_447[5:4] <= 2'b00;
    zext_ln11_reg_447[63:10] <= 54'b000000000000000000000000000000000000000000000000000000;
end
